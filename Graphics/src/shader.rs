...
/*
This code was made not as part of my TFG but given to me 
as source code to use in an assignment of 
TDT4195 Grunnleggende visuell databehandling (2023 HØST)
